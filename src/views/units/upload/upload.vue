...
<script>
    import { getVendorPrefix,getTranslateInfo,Base64ToBlob } from  '../../../lib/utils'
    import noIcon from '../../../image/option/crop-no.png'
    import yesIcon from '../../../image/option/crop-yes.png'
    export default {
        data () {
            return {
                height:300,
